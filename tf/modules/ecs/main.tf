...
resource "aws_alb" "application_load_balancer" {
    name               = "cs-alb-${var.env}" # Naming our load balancer
...
locals {
    ecs_servcie_secrets = var.env == "prod" ? "arn:aws:secretsmanager:us-east-1:482352589093:secret:prod-cs-config-9QASbT" : "arn:aws:secretsmanager:us-east-1:482352589093:secret:qa-cs-config-bNTQ2q"
